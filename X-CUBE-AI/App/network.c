...
#define AI_NETWORK_MODEL_SIGNATURE     "b505bbf06a7447ed9df953e04cd65dea"
...
#define AI_TOOLS_DATE_TIME   "Mon Jun 15 22:29:20 2020"
...
AI_STATIC ai_array conv2d_3_output_array;   /* Array #11 */
AI_STATIC ai_array conv2d_4_output_array;   /* Array #12 */
AI_STATIC ai_array dense_3_output_array;   /* Array #13 */
AI_STATIC ai_array dense_3_nl_output_array;   /* Array #14 */
AI_STATIC ai_array dense_4_output_array;   /* Array #15 */
AI_STATIC ai_array dense_4_nl_output_array;   /* Array #16 */
...
AI_STATIC ai_tensor conv2d_3_output;   /* Tensor #11 */
AI_STATIC ai_tensor conv2d_4_output;   /* Tensor #12 */
AI_STATIC ai_tensor conv2d_4_output0;   /* Tensor #13 */
AI_STATIC ai_tensor dense_3_output;   /* Tensor #14 */
AI_STATIC ai_tensor dense_3_nl_output;   /* Tensor #15 */
AI_STATIC ai_tensor dense_4_output;   /* Tensor #16 */
AI_STATIC ai_tensor dense_4_nl_output;   /* Tensor #17 */


/**  Forward network tensor chain declarations  *******************************/
AI_STATIC_CONST ai_tensor_chain conv2d_3_chain;   /* Chain #0 */
AI_STATIC_CONST ai_tensor_chain conv2d_4_chain;   /* Chain #1 */
AI_STATIC_CONST ai_tensor_chain dense_3_chain;   /* Chain #2 */
AI_STATIC_CONST ai_tensor_chain dense_3_nl_chain;   /* Chain #3 */
AI_STATIC_CONST ai_tensor_chain dense_4_chain;   /* Chain #4 */
AI_STATIC_CONST ai_tensor_chain dense_4_nl_chain;   /* Chain #5 */


/**  Forward network layer declarations  **************************************/
AI_STATIC ai_layer_conv2d_nl_pool conv2d_3_layer; /* Layer #0 */
AI_STATIC ai_layer_conv2d_nl_pool conv2d_4_layer; /* Layer #1 */
AI_STATIC ai_layer_dense dense_3_layer; /* Layer #2 */
AI_STATIC ai_layer_nl dense_3_nl_layer; /* Layer #3 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 10, 3), AI_STRIDE_INIT(4, 4, 4, 128, 1280),
  1, &conv2d_4_scratch0_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_3_scratch0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 26, 3), AI_STRIDE_INIT(4, 4, 4, 64, 1664),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 512, 128, 1, 1), AI_STRIDE_INIT(4, 4, 2048, 262144, 262144),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 16, 12, 12), AI_STRIDE_INIT(4, 4, 4, 64, 768),
  1, &conv2d_3_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_4_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 4, 4), AI_STRIDE_INIT(4, 4, 4, 128, 512),
